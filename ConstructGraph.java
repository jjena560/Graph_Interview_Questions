...
// graph is an Array of ArrayList
// so when we do graph[src], we'll get ArrayList and then we iterate throught this ArrayList,
// we'll get Edges from the source
class Edge {
    int src, nbr, weight;

    Edge(int src, int nbr, int weight) {
        this.src = src;
        this.nbr = nbr; // all the neighbor of the source or the current vertex
        this.weight = weight;
    }
}
